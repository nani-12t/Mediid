...
import { Shield, LayoutDashboard, User, Calendar, Search, ShieldCheck, LogOut, Menu, X, Bell, FileText, Droplet, Receipt } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/blood-donation', icon: Droplet, label: 'Blood & Organs' },
  { to: '/insurance', icon: ShieldCheck, label: 'Insurance' },
  { to: '/history', icon: FileText, label: 'Medical History' },
  { to: '/bills', icon: Receipt, label: 'Bills & Expenses' },
